...
$this->title = Yii::t('app', 'Staf Kategori Surat');
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="staf-kategori-surat-index">

                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/kategori_surat/create')? Html::a(Yii::t('app', 'TAMBAH KATEGORI BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_kategori_surat.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
