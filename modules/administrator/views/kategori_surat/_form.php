    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="staf-kategori-surat-form">

                    <?php $form = ActiveForm::begin(); ?>

                    <?= $form->field($model, 'nama_kategori', $template)->textInput(['maxlength' => true]) ?>

                    <?= $form->field($model, 'dekripsi', $template)->textInput(['maxlength' => true]) ?>
