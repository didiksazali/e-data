...
$this->title = Yii::t('app', 'Staf Template Surats');
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="staf-surat-masuk-index">
                    ...
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/surat_masuk/create')? Html::a(Yii::t('app', 'TAMBAH TEMPLATE BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            'nama_template',
                            [
                                'attribute' => 'untuk sekolah',
                                //'label'=> 'Status Sekolah',
                                'format'=>'raw',
                                //'width' => '150px',
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return  '<span class="label bg-blue">'.$models->uidUntukSekolah->nama.'</span>';
                                }
                            ],
                            ...
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return $models->status!=1?'<span class="badge bg-pink">Tidak Aktif</span>':'<span class="badge bg-blue">Aktif</span>';
                                }
                            ],
                            // 'create_by',
                            // 'create_at',
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_template_surat.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
