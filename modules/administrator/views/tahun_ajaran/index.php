        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="tahun-ajaran-index">
                    ...
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/data_kelas/create')? Html::a(Yii::t('app', 'TAMBAH KELAS BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>

                    <?php
                    $action= '';
                    if(\Yii::$app->user->can('app/administrator/tahun_ajaran/view')){
                        $action= $action.'{view} ';
                    }
                    if(\Yii::$app->user->can('app/administrator/tahun_ajaran/update')){
                        $action= $action.'{update} ';
                    }
                    if(\Yii::$app->user->can('app/administrator/tahun_ajaran/delete')){
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_thn_ajaran.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
...
$js=<<< JAVASCRIPT
    $('document').ready(function(){
            ...
            $.ajax({
              url: '$homeUrl\administrator/tahun_ajaran/delete',
