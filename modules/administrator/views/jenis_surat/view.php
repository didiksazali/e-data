...
$this->title = 'Detail Jenis Surat: '.$model->nama_jenis_surat;
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="body">
                                <div class="staf-jenis-surat-view">
                                    <?= DetailView::widget([
                                        'model' => $model,
                                ...
                                <p>
                                    <?= \Yii::$app->user->can('app/administrator/data_kelas/update')?Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->uid_jenis_surat], ['class' => 'btn bg-teal btn-lg waves-effect']):''; ?>
                                    <?= \Yii::$app->user->can('app/administrator/data_kelas/delete')?'<a href="#"><button class="delete btn bg-red btn-lg waves-effect" id="'.$model->uid_jenis_surat.'">Delete</button></a>':'' ?>
                                </p>
                            </div>
                        </div>
                    </div>
