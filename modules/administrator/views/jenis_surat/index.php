...
$this->title = Yii::t('app', 'Data Jenis Surat Baru');
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="staf-jenis-surat-index">

                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/data_staf/create')? Html::a(Yii::t('app', 'TAMBAH JENIS SURAT BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($models) {
                                    return $models->uidTemplateSurat->nama_template;
                                }
                            ],
                            [
                                'attribute' => 'sekolah',
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return  '<span class="label bg-deep-orange">'.$models->uidTemplateSurat->uidUntukSekolah->nama.'</span>';
                                }
                            ],
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return $models->estimasi_selesai.' Hari';
                                }
                            ],
                            //'biaya',
                            // 'no_surat',
                            ...
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return $models->status!=1?'<span class="label bg-blue">Aktif</span>':'<span class="label bg-pink">Tidak Aktif</span>';
                                }
                            ],
                            // 'create_by',
                            // 'create_at',
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_jenis_surat.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
...
$js=<<< JAVASCRIPT
    $('document').ready(function(){
            ...
            $.ajax({
              url: '$homeUrl\administrator/jenis_surat/delete',
