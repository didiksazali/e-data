...
$this->title = Yii::t('app', 'Dm Jabatans');
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="dm-jabatan-index">
                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/buat_surat/create')? Html::a(Yii::t('app', 'TAMBAH JABATAN BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            'nama_jabatan',
                            [
                                'attribute' => 'deskripsi_jabatan',
                                //'label'=> 'Status Sekolah',
                                'format'=>'raw',
                                //'width' => '150px',
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return substr($models->deskripsi_jabatan, 0, 250).'...';
                                }
                            ],
                            // 'update_at',
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->kode_jabatan.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
...
$js=<<< JAVASCRIPT
    $('document').ready(function(){
            ...
            $.ajax({
              url: '$homeUrl\administrator/data_jabatan/delete',
