                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($models) {
                                    return '<span>'.date('d-m-y', strtotime($models->tanggal_masuk)).'</span>';
                                }
                            ],
                            'dari',
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return '<span class="label bg-blue">'.$models->tujuanSuratKesekolah->nama.'</span>';
                                }
                            ],
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return '<span class="label bg-red">'.$models->uidKategoriSurat->nama_kategori.'</span>';
                                }
                            ],
                            [
                                'attribute' => 'maksud_surat',
                                //'label'=> 'Status Sekolah',
                                'format'=>'raw',
                                //'width' => '150px',
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return $models->maksud_surat;
                                }
                            ],
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_surat_masuk.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
