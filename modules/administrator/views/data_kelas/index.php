...
$this->title = Yii::t('app', 'Data Master Kelas');
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($models) {
                                    return '<span class="label bg-blue">'.$models->uidSekolah->nama.'</span>';
                                }
                            ],
                            'kode_kelas',
                            'nama_kelas',
                            ...
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_kelas.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
