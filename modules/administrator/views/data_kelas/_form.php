            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="kelas-form">
                        ...
                        <?= $form->field($model, 'uid_sekolah', $template_ddl)->dropDownList($sekolah, ['prompt'=>'--pilih salah satu--', 'class'=>'form-control show-tick']) ?>

                        <?= $form->field($model, 'kode_kelas', $template)->textInput(['maxlength' => true]) ?>

                        <?= $form->field($model, 'nama_kelas', $template)->textInput(['maxlength' => true]) ?>

                        <?= $form->field($model, 'ruangan_kelas', $template)->textInput(['maxlength' => true]) ?>
