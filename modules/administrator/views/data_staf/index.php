...
$this->title = Yii::t('app', 'Data Staf');
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="staf-index">

                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                    <p>
                        <?= \Yii::$app->user->can('app/administrator/data_staf/create')? Html::a(Yii::t('app', 'TAMBAH STAF BARU'), ['create'], ['class' => 'button button-3d button-primary button-rounded waves-effect']):'' ?>
                    </p>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($models) {
                                    return $models->jenis_kelamin==1?'Laki-laki':'Perempuan';
                                }
                            ],
                            'alamat',
                            [
                                ...
                                //'headerOptions' => ['style' => 'width:20%'],
                                'value' => function ($models) {
                                    return $models->jabatanStaf->nama_jabatan;
                                }
                            ],
                            [
                                ...
                                'buttons'=>[
                                    'delete'=>function($url, $model){
                                        return '<button id="'.$model->uid_staf.'" title="Delete" class="delete button button-caution button-square button-small button-longshadow-right"><i class="glyphicon glyphicon-trash"></i></button>';
                                    }
                                ],
