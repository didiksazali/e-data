...
use app\modules\administrator\models\search\DataKelasSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Data_kelas_list_listController implements the CRUD actions for Kelas model.
 */
class Data_kelas_list_listController extends Controller
{
    /**
     * @inheritdoc
     */
