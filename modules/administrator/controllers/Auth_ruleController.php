...
use Yii;
use app\modules\administrator\models\AuthRule;
use app\modules\administrator\models\AuthRuleSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Auth_ruleController implements the CRUD actions for AuthRule model.
 */
class Auth_ruleController extends Controller
{
